...
class Exercise5: UIViewController {
       ...
       let screenHeight = UIScreen.main.bounds.height
        ...
        override func viewDidLoad() {
           ...
           selectedExercises = selectedString.components(separatedBy: " ")
                ...
                let k = UserDefaults.standard.integer(forKey: "exercise4_level")
                print(k)
   ...
   override func viewWillDisappear(_ animated: Bool) {
    ...
    func saveSetting(){
        ...
        defaults.set(Int(speedSlider.value * 100), forKey: "exercise4_level")
//        defaults.set(self.rowNumbers, forKey: "exercise5_row")
    //        defaults.setColor(color: customColor, forKey: "color")
       ...
       @objc func setRandomBackgroundColor() {
           ...
           if internalCounter == 0 {
            ...
            if counter >= selectedExercises.count - 3 {self.counter = -2}
            self.counter = self.counter + 2
            self.wordLbl13.text = self.selectedExercises[self.counter] + " " + self.selectedExercises[self.counter + 1]
            if counter >= selectedExercises.count - 3 {self.counter = -2}
            self.counter = self.counter + 2
            self.wordLbl14.text = self.selectedExercises[self.counter] + " " + self.selectedExercises[self.counter + 1]
            if counter >= selectedExercises.count - 3 {self.counter = -2}
            self.counter = self.counter + 2
            self.wordLbl15.text = self.selectedExercises[self.counter] + " " + self.selectedExercises[self.counter + 1]
            if counter >= selectedExercises.count - 3 {self.counter = -2}
            self.counter = self.counter + 2
            self.wordLbl16.text = self.selectedExercises[self.counter] + " " + self.selectedExercises[self.counter + 1]
            if counter >= selectedExercises.count - 3 {self.counter = -2}
            self.counter = self.counter + 2
            self.wordLbl17.text = self.selectedExercises[self.counter] + " " + self.selectedExercises[self.counter + 1]
            if counter >= selectedExercises.count - 3 {self.counter = -2}
            self.counter = self.counter + 2
            self.wordLbl18.text = self.selectedExercises[self.counter] + " " + self.selectedExercises[self.counter + 1]
            if counter >= selectedExercises.count - 3 {self.counter = -2}
            self.counter = self.counter + 2
            self.wordLbl19.text = self.selectedExercises[self.counter] + " " + self.selectedExercises[self.counter + 1]
            if counter >= selectedExercises.count - 3 {self.counter = -2}
            self.counter = self.counter + 2
            self.wordLbl20.text = self.selectedExercises[self.counter] + " " + self.selectedExercises[self.counter + 1]
            if counter >= selectedExercises.count - 3 {self.counter = -2}
            self.counter = self.counter + 2
            self.wordLbl21.text = self.selectedExercises[self.counter] + " " + self.selectedExercises[self.counter + 1]
            if counter >= selectedExercises.count - 3 {self.counter = -2}
            self.counter = self.counter + 2
            self.wordLbl22.text = self.selectedExercises[self.counter] + " " + self.selectedExercises[self.counter + 1]
            if counter >= selectedExercises.count - 3 {self.counter = -2}
            self.counter = self.counter + 2
            self.wordLbl23.text = self.selectedExercises[self.counter] + " " + self.selectedExercises[self.counter + 1]
            if counter >= selectedExercises.count - 3 {self.counter = -2}
            self.counter = self.counter + 2
            self.wordLbl24.text = self.selectedExercises[self.counter] + " " + self.selectedExercises[self.counter + 1]
    ...
    @IBAction func editBtnPressed(_ sender: Any) {
        performSegue(withIdentifier: "edit5", sender: self)
    }
