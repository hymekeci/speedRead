...
class Exercise17: UIViewController {
   ...
   override func viewDidLoad() {
      ...
      selectedExercises = selectedString.components(separatedBy: " ")         //
         ...
         let k = UserDefaults.standard.integer(forKey: "exercise13_level")
         print(k)
         ...
         //
         self.rowNumbers = UserDefaults.standard.integer(forKey: "exercise13_row")
         ...
         //label
//        wordLbl.topAnchor.constraint(equalTo: view.topAnchor, constant: screenHeight / 2 - 50)
        wordLbl.layer.cornerRadius = 8
        wordLbl.text = selectedExercises[0]
        wordLbl2.layer.cornerRadius = 8
//        wordLbl2.topAnchor.constraint(equalTo: view.topAnchor, constant: screenHeight / 2 - 99.5)
     ...
     func saveSetting(){
         ...
         defaults.set(Int(speedSlider.value * 100), forKey: "exercise13_level")
         defaults.set(self.rowNumbers, forKey: "exercise13_row")
    ...
    @objc func setRandomBackgroundColor() {
        ...
        if isShow{
            for i in 1...rowNumbers{
                ...
                oldString += self.selectedExercises[k]
                if i != rowNumbers{
                    self.wordLbl.text! += " "
                    oldString += " "
                }
