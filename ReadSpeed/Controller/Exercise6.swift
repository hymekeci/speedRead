...
class Exercise6: UIViewController {
...
//              var rowNumbers: Int = 1
        ...
        override func viewDidLoad() {
           ...
           selectedExercises = selectedString.components(separatedBy: " ")
                        ...
                        let k = UserDefaults.standard.integer(forKey: "exercise5_level")
                        print(k)
    ...
    func animating(){
       ...
       func saveSetting(){
           ...
           defaults.set(Int(speedSlider.value * 100), forKey: "exercise5_level")
//           defaults.set(self.rowNumbers, forKey: "exercise5_row")
    ...
    @IBAction func editBtnPressed(_ sender: Any) {
        performSegue(withIdentifier: "edit6", sender: self)
    }
