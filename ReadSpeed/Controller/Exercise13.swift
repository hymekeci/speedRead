...
class Exercise13: UIViewController {
   ...
   @IBOutlet weak var wordLbl12: UILabel!
    ...
    override func viewDidLoad() {
       ...
       selectedExercises = selectedString.components(separatedBy: " ")//
            ...
            let k = UserDefaults.standard.integer(forKey: "exercise9_level")
            print(k)
    ...
    func animating(){
      ...
      func saveSetting(){
          ...
          defaults.set(Int(speedSlider.value * 100), forKey: "exercise9_level")
   ...
   func filteredTime(num: Int) -> String{
       ...
       @objc func setRandomBackgroundColor() {
           ...
           if internalCounter == 0 {
            ...
            if self.counter == number - 2 {
                self.counter = 0
            }
           
            self.wordLbl2.text = self.selectedExercises[self.counter] + "  " + self.selectedExercises[self.counter + 1] + "  " + self.selectedExercises[self.counter + 2]//123
           
            self.counter = self.counter + 3//4
            if self.counter >= number {
                self.counter = 0
            }
            self.wordLbl3.text = self.selectedExercises[self.counter]//4
               
            self.counter = self.counter + 1//5
            if self.counter == number {
                self.counter = 0
            }
            self.wordLbl4.text = self.selectedExercises[self.counter]//5
               
            self.counter = self.counter + 1//6
            if self.counter >= number - 2 {
                self.counter = 0
            }
            self.wordLbl5.text =  self.selectedExercises[self.counter] + "  " + self.selectedExercises[self.counter + 1] + "  " + self.selectedExercises[self.counter + 2]//678
               
            self.counter = self.counter + 3//9
            if self.counter >= number {
                self.counter = 0
            }
            self.wordLbl6.text = self.selectedExercises[self.counter]//9
            ...
            self.counter = self.counter + 1//131415
            if self.counter >= number - 2 {
                self.counter = 0
            }
            ...
            self.wordLbl26.text =  self.selectedExercises[self.counter] + "  " + self.selectedExercises[self.counter + 1] + "  " + self.selectedExercises[self.counter + 2]
            ...
            self.wordLbl29.text =  self.selectedExercises[self.counter] + "  " + self.selectedExercises[self.counter + 1] + "  " + self.selectedExercises[self.counter + 2]
            ...
            self.wordLbl32.text =  self.selectedExercises[self.counter] + "  " + self.selectedExercises[self.counter + 1] + "  " + self.selectedExercises[self.counter + 2]
            ...
            self.wordLbl35.text =  self.selectedExercises[self.counter] + "  " + self.selectedExercises[self.counter + 1] + "  " + self.selectedExercises[self.counter + 2]
    ...
    @IBAction func editBtnPressed(_ sender: Any) {
        performSegue(withIdentifier: "edit13", sender: self)
    }
