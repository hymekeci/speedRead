...
class Exercise14: UIViewController {
...
@IBOutlet weak var one: UIImageView!
              ...
              override func viewDidLoad() {
                 ...
                 selectedExercises = selectedString.components(separatedBy: " ")
                     //
                       ...
                       let k = UserDefaults.standard.integer(forKey: "exercise10_level")
                       print(k)
    ...
    //save setting
      func saveSetting(){
          ...
          defaults.set(Int(speedSlider.value * 100), forKey: "exercise10_level")
    //          defaults.set(self.rowNumbers, forKey: "exercise14_row")
      ...
      @IBAction func speedSlider(_ sender: UISlider) {
        ...
        func filteredTime(num: Int) -> String{
          ...
          @objc func setRandomBackgroundColor() {
              ...
              if internalCounter == 0 {
                  //Input data
               let number = selectedExercises.count
                  //0
               if self.counter >= number {
                   self.counter = 0
               }
               self.wordLbl1.text = self.selectedExercises[self.counter]//0
            ...
            self.wordLbl2.text = self.selectedExercises[self.counter]//0
                ...
                self.wordLbl3.text = self.selectedExercises[self.counter]//0
                                       
                self.counter = self.counter + 1//1
                if self.counter >= number {
                    self.counter = 0
                }
                self.wordLbl4.text = self.selectedExercises[self.counter]//0
                                       
                self.counter = self.counter + 1//1
                if self.counter >= number {
                    self.counter = 0
                }
                self.wordLbl5.text = self.selectedExercises[self.counter]//0
                                    
                self.counter = self.counter + 1//1
                if self.counter >= number {
                    self.counter = 0
                }
                self.wordLbl6.text = self.selectedExercises[self.counter]//0
                                       
                self.counter = self.counter + 1//1
                if self.counter >= number {
                    self.counter = 0
                }
                self.wordLbl7.text = self.selectedExercises[self.counter]//0
                                       
                self.counter = self.counter + 1//1
                if self.counter >= number {
                    self.counter = 0
                }
                self.wordLbl8.text = self.selectedExercises[self.counter]//0
                                       
                self.counter = self.counter + 1//1
                if self.counter >= number {
                    self.counter = 0
                }
                self.wordLbl9.text = self.selectedExercises[self.counter]//0
                                       
                self.counter = self.counter + 1//1
                if self.counter >= number {
                    self.counter = 0
                }
                self.wordLbl10.text = self.selectedExercises[self.counter]//0
                                       
                self.counter = self.counter + 1//1
                if self.counter >= number {
                    self.counter = 0
                }
                self.wordLbl11.text = self.selectedExercises[self.counter]//0
                                       
                self.counter = self.counter + 1//1
                if self.counter >= number {
                    self.counter = 0
                }
                self.wordLbl12.text = self.selectedExercises[self.counter]//0
                                       
                self.counter = self.counter + 1//1
                if self.counter >= number {
                    self.counter = 0
                }
                self.wordLbl13.text = self.selectedExercises[self.counter]//0
                                       
                self.counter = self.counter + 1//1
                if self.counter >= number {
                    self.counter = 0
                }
                self.wordLbl14.text = self.selectedExercises[self.counter]//0
                                       
                self.counter = self.counter + 1//1
                if self.counter >= number {
                    self.counter = 0
                }
                self.wordLbl15.text = self.selectedExercises[self.counter]//0
                                       
                self.counter = self.counter + 1//1
                if self.counter >= number {
                    self.counter = 0
                }
                self.wordLbl16.text = self.selectedExercises[self.counter]//0
                                       
                self.counter = self.counter + 1//1
                if self.counter >= number {
                    self.counter = 0
                }
                self.wordLbl17.text = self.selectedExercises[self.counter]//0
                                       
                self.counter = self.counter + 1//1
                if self.counter >= number {
                    self.counter = 0
                }
                self.wordLbl18.text = self.selectedExercises[self.counter]//0
                                       
                self.counter = self.counter + 1//1
                if self.counter >= number {
                    self.counter = 0
                }
                self.wordLbl19.text = self.selectedExercises[self.counter]//0
                                       
                self.counter = self.counter + 1//1
                if self.counter >= number {
                    self.counter = 0
                }
                self.wordLbl20.text = self.selectedExercises[self.counter]//0
                                       
                self.counter = self.counter + 1//1
                if self.counter >= number {
                    self.counter = 0
                }
                self.wordLbl21.text = self.selectedExercises[self.counter]//0
                                       
                self.counter = self.counter + 1//1
                if self.counter >= number {
                    self.counter = 0
                }
                self.wordLbl22.text = self.selectedExercises[self.counter]//0
                                       
                self.counter = self.counter + 1//1
                if self.counter >= number {
                    self.counter = 0
                }
                self.wordLbl23.text = self.selectedExercises[self.counter]//0
                                       
                self.counter = self.counter + 1//1
                if self.counter >= number {
                    self.counter = 0
                }
                self.wordLbl24.text = self.selectedExercises[self.counter]//0
                                                             
                self.counter = self.counter + 1//1
                if self.counter >= number {
                    self.counter = 0
                }
                self.wordLbl25.text = self.selectedExercises[self.counter]//0
                self.counter = self.counter + 1//1
                if self.counter >= number {
                    self.counter = 0
                }
                self.wordLbl26.text = self.selectedExercises[self.counter]//0
                self.counter = self.counter + 1//1
                if self.counter >= number {
                    self.counter = 0
                }
              self.wordLbl27.text = self.selectedExercises[self.counter]//0
               
              self.counter = self.counter + 1//1
              if self.counter >= number {
                  self.counter = 0
              }
              self.wordLbl28.text = self.selectedExercises[self.counter]//0
              self.counter = self.counter + 1//1
              if self.counter >= number {
                  self.counter = 0
              }
              self.wordLbl29.text = self.selectedExercises[self.counter]//0
               
              self.counter = self.counter + 1//1
              if self.counter >= number {
                  self.counter = 0
              }
              self.wordLbl30.text = self.selectedExercises[self.counter]//0
               
              self.counter = self.counter + 1//1
              if self.counter >= number {
                  self.counter = 0
              }
              self.wordLbl31.text = self.selectedExercises[self.counter]//0
               
              self.counter = self.counter + 1//1
              if self.counter >= number {
                  self.counter = 0
              }
              self.wordLbl32.text = self.selectedExercises[self.counter]//0
               
              self.counter = self.counter + 1//1
              if self.counter >= number {
                  self.counter = 0
              }
              self.wordLbl33.text = self.selectedExercises[self.counter]//0
               
              self.counter = self.counter + 1//1
              if self.counter >= number {
                  self.counter = 0
              }
              self.wordLbl34.text = self.selectedExercises[self.counter]//0
               
              self.counter = self.counter + 1//1
              if self.counter >= number {
                  self.counter = 0
              }
              self.wordLbl35.text = self.selectedExercises[self.counter]//0
               
              self.counter = self.counter + 1//1
              if self.counter >= number {
                  self.counter = 0
              }
              self.wordLbl36.text = self.selectedExercises[self.counter]//0
        ...
        @IBAction func editBtnPressed(_ sender: Any) {
            performSegue(withIdentifier: "edit14", sender: self)
        }
